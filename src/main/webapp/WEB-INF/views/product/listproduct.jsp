                            ...
                            <li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                    <li ><a href="${pageContext.request.contextPath}/product/addproduct"><i class="fa fa-plus-square"></i>Add Product</a></li>
                     				<li class="active"><a href="${pageContext.request.contextPath}/product/listproduct"><i class="glyphicon glyphicon-list"></i>List Product</a></li>
		...
		<div class="content-page">
			...
			<div class="content">
				<div class="container">
					...
					<div class="row">
						<div class="col-sm-12">
							<h4 class="page-title">Manage Product | List Product</h4>
							<p class="text-muted page-title-alt">Welcome to admin
								panel !</p>
						</div>
					</div>
