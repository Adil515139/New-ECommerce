                            ...
                            <ul class="nav navbar-nav navbar-right pull-right">
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a href="${pageContext.request.contextPath}/admin/profile"></i> Profile</a></li>
                    ...
                    <div class="container">
						...
						<div class="row">
							<div class="col-sm-12" align="left">
								<h4 class="page-title">Product | Update Product</h4>
								<ol class="breadcrumb">
								
                                    <li>
										<a href="${pageContext.request.contextPath}/product/listproduct">List Product</a>
									</li>
									<li class="active">
										Update Product
									</li>
                                        ...
                                        <div class="row" >
 										...
 										<form:form  action="${pageContext.request.contextPath}/product/updateproduct"  method="POST"  modelAttribute="product">
 										
 										
 												<div class="row">

									<b style="font-size: 20px">Product ID : ${product.id } </b>
									<br> <br> <br>

								</div>
 										 <form:hidden path="created_at" name="created_at"/>
                                                   <form:hidden path="" name="modified_at"/>
                                                    <div class="form-group m-b-20">
                                                         <label>Product Name: <span class="text-danger">*</span></label>
                                                        <form:input path="product_name" name="product_name" value="${product.product_name}" data-parsley-required-message="Product Name is reqiured" parsley-trigger="change"  class="form-control" required="null" placeholder="Enter Product Name"/>
                                                   <form:errors name="product_name" cssClass="error" />
                                                    </div>

                                                   <form:hidden path="" name="id" value="${product.id }"/>
                                                    <div class="form-group m-b-20">
                                                        <label>Product Description: <span class="text-danger">*</span></label>
                                                        <form:textarea path="description" name="description" value="${product.description}" parsley-trigger="change" data-parsley-required-message="Product Description is reqiured" required="null" class="form-control" placeholder="Enter Product Description"/>
                                                    </div>
											...
											<!--  <div class="col-sm-13">
													<label>Supplier: <span class="text-danger">*</span></label> -->
                                                        ...
                                                        <form:select path="" name="supplier" class="form-control" parsley-trigger="change" data-parsley-required-message="You must select atleast one Supplier" required="null">
                                                    ...
                                                    <div class="form-group m-b-20">
                                                        ...
                                                        <form:input path="" name="quantity" value="${product.quantity}" class="form-control" data-parsley-required-message="Quantity is reqiured" parsley-trigger="change" required="null" />
                                                    </div>
                                                    </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group m-b-20">
                                                        ...
                                                        <form:input path="" name="price" value="${product.price}" class="form-control" data-parsley-required-message="Price is reqiured" parsley-trigger="change" required="null" />
                                                    </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group m-b-20">
                                                        ...
                                                        <form:input path="" name="discount" value="${product.discount}" class="form-control" parsley-trigger="change" />
                                                    </div>
                                                    ...
                                                    <div class="form-group m-b-20">
                                                        ...
                                                        <br/>
                                                          <label>Online
                                                               <form:radiobutton path="status" id="online" name="status"  value="online"  required="null"  data-parsley-required-message="Please choose online or offline"/>
                                                               </label>
                                                              <label>Offline
                                                            <form:radiobutton path="status" name="status"  value="offline"/>
                                                         </label>
                                                            <!-- 
