                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
							<div class="col-lg-12">
								<div class="card-box">
									<h4 class="m-t-0 header-title"><b>Page Content | Add FAQs Details</b></h4>
									<p class="text-muted font-13 m-b-30">
	                                    
	                                </p>
		                        
									<form:form action="${pageContext.request.contextPath}/pagecontent/addfaqs" method="POST" modelAttribute="faqs" >
										...
										<div class="form-group">
											...
											<form:input type="text" path="" name="question" parsley-trigger="change" required ="null" data-parsley-required-message="Question is reqiured" required-placeholder="Enter Question" class="form-control"  />
										</div>
                           ...
                           <label class="col-md-2 control-label">Answer</label>
							<div class="col-sm-12">
									...
									<form:textarea id="elm1" path=""  name="answer" required="null"  data-parsley-required-message="Answer is reqiured"></form:textarea>
										...
										<div class="form-group text-right m-b-0">
											...
											<button id="RESET" type="reset" class="btn btn-warning waves-effect waves-light m-l-5">
