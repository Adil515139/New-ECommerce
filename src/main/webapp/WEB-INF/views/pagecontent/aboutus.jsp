                    ...
                    <div id="sidebar-menu">
                        <ul>
                            ...
                            <li class="has_sub">
                                ...
                                <ul >
                                <li class="active">
                                <a href="${pageContext.request.contextPath}/pagecontent/aboutus" class="waves-effect active"><i class="glyphicon glyphicon-edit"></i> <span> About us </span> </a>
                            </li>
                                <li>
...
<div class="content-page">
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <h4 class="page-title">Page Content | About Us</h4>
                        ...
                        <div class="row">
							<div class="col-lg-12">
								<div class="card-box">
									<h4 class="m-t-0 header-title"><b>Add About Us Details</b></h4>
									<p class="text-muted font-13 m-b-30">
	                                    
	                                </p>
		                        
									<form  action="${pageContext.request.contextPath}/pagecontent/aboutus" method="POST"  >
									
										
										
										<input type="text" name="id" value="${pagecontent.id}" hidden="true">
										<input type="text" name="type" value="AboutUs" hidden="true">
						...
						<textarea id="elm1" path="description"  class="form-control"  name="description" data-parsley-required-message="Description is reqiured" required="null" >
