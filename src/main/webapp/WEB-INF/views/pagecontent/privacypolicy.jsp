                    ...
                    <div id="sidebar-menu">
                        <ul>
                            ...
                            <li class="has_sub">
                                ...
                                <li class="active">
                                <a href="${pageContext.request.contextPath}/pagecontent/privacypolicy" class="waves-effect active"><i class="glyphicon glyphicon-edit"></i> <span> Privacy Policy</span> </a>
                            </li>
                                <li>
...
<div class="content-page">
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <h4 class="page-title">Page Content | Privacy Policy</h4>
                        ...
                        <div class="row">
							<div class="col-lg-12">
								<div class="card-box">
									<h4 class="m-t-0 header-title"><b>Add Privacy Policy Details</b></h4>
									<p class="text-muted font-13 m-b-30">
	                                    
	                                </p>
		                        
									<form  action="${pageContext.request.contextPath}/pagecontent/privacypolicy" method="POST"  >
