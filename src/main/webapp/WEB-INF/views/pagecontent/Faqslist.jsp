...
<html>
             ...
             <div class="content-page">
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <h4 class="page-title">Page Content | FAQs</h4>
 ...
 -->-
 <div>
 <button type="button" onclick="window.location.href = '${pageContext.request.contextPath}/pagecontent/addfaqs';"   class="btn btn-success waves-effect waves-light m-l-10 btn-md">+ADD</button>
 </div>
 
 
                        			<div class="table-responsive">
                                        <table class="table table-actions-bar" id="faqslist">
                                            <thead>
                                                <tr>
...
<!-- ---------------------------------------------------------------------Ajax se data aaraha he-------------------------------		
	...
	$(document).ready(
						...
						.DataTable(
							{
							    ...
							    "ajax": "${pageContext.request.contextPath}/pagecontent/pagecontent/Faqslist",
								"type" : "GET",
								"columns" : [ 
								...
								
								{
									"data" : "active",
										...
										"render" : function(data, type, row, meta){
											...
											return "<i class='glyphicon glyphicon-ok-circle text-success'></i>"
												...
												return " <i class='glyphicon  glyphicon-remove-circle text-danger'></i>"
												}
											}
								...
								
 								 {
									data : "id",
									"render" : function(data, type, row, meta){
										return "<a href='${pageContext.request.contextPath}/pagecontent/updatefaqs/" + row.id + "' class='md md-edit'> </a> <i onclick='deleteFunction(" + row.id + ");' class=' glyphicon glyphicon-trash'> </i>";
									},  
		...
		<!-- <--------------------------------------------------------/FAQs List Function END---------------------------------------------->  -->
		
		
		 	<!-- <--------------------------------------------------------/Delete Function START---------------------------------------------->  -->
	
<script>
	function deleteFunction(faqsid){
		...
		swal({   
	        ...
	        confirmButtonText: "Delete FAQs",   
	        closeOnConfirm: false 
	    }, function(){
	    	swal({title:"Deleting...", text:"FAQs has been deleting...",
	    		type:"info",
...
$.ajax({
	url:'${pageContext.request.contextPath}/pagecontent/deletefaqs/'+faqsid,
	type: 'POST',
	dataType:'json',
	...
	success: function(event){
	    ...
	    swal(
			    {
				    title:"Deleted", 
				    text:"FAQs has been deleted successfully",
				     type:"success"
				},(function refreshTable(){
					
					 $('#faqslist').DataTable().clear();
		$('#faqslist').DataTable().ajax.reload();
				}
	));
	}
});
