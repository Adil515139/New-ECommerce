...
<html>
    <head>
        ...
        <title>E-Commerce | Update FAQs</title>
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12" align="left">
                                ...
                                <ol class="breadcrumb">
                                   	 <li>
										<a href="${pageContext.request.contextPath}/pagecontent/Faqslist">FAQs List</a>
									</li>
                        ...
                        <div class="row">
							<div class="col-lg-12">
								<div class="card-box">
									<h4 class="m-t-0 header-title"><b>Page Content | Update FAQs Details</b></h4>
									<p class="text-muted font-13 m-b-30">
	                                    
	                                </p>
		                        
									<form:form action="${pageContext.request.contextPath}/pagecontent/updatefaqs" method="POST" modelAttribute="faqs" >
									 	 <!--  <div class="switchery-demo"> 
		                                  <label for="userName">Active</label>
		                                  <br>
		                                   <input type="checkbox" checked data-plugin="switchery" data-color="#81c868" data-size="small"/>     </div> -->
										...
										<div class="form-group">
											...
											<form:input type="text" name="question" path="question" parsley-trigger="change" required ="null" data-parsley-required-message="Question is reqiured" required-placeholder="Enter user name" class="form-control" id="question" />
										</div>
                           ...
                           <label class="col-md-2 control-label">Answer</label>
							<div class="col-sm-12">
									...
									<form:textarea id="elm1" path="answer"  class="form-control"  name="answer" data-parsley-required-message="Answer is reqiured" required="null" />
								</div>
							</div>
  ...
  <script src="${pageContext.request.contextPath}/resources/assets/plugins/summernote/dist/summernote.min.js"></script>
	<script
	...
	<!-- 			 <script>
        $(document).ready(function () {
            ...
            $('#cancel').hide();
        	 ...
        	 $('.inline-editor').prop('contenteditable', true); 
         	
         $('#elm1').next().find(".inline-editor").attr("contenteditable", false);
