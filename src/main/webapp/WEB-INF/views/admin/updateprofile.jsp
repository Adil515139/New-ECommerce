                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
							<div class="col-lg-6">
								<div class="card-box">
									<h4 class="m-t-0 header-title"><b>Update Admin Profile</b></h4>
									<hr>
		                                       
									<form:form action="${pageContext.request.contextPath}/admin/updateprofile" method="POST" modelAttribute="admin"> 
									
									<form:hidden path="id"/>
									<!-- 	
										<div class="form-group">
											<form:label  path="" name ="name" for="userName">Name*</form:label>
											<form:input path="" class="form-control" value="" name="name" />
										</div> -->
										
										<div class="form-group">
											Email*:
											<form:input type="email" class="form-control" path="email"  required="null"/>
										</div>
										
										<div class="form-group">
											Password*:
											<form:input type="text" class="form-control" path="password" value="${sessionScope.admin.password}"  required="null" name="password"/>
