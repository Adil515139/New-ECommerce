                    ...
                    <div id="sidebar-menu">
                        <ul>
                            ...
                            <li class="has_sub">
                                ...
                                <li class="has_sub">
                                <a href="#" class="waves-effect active"><i class=" md-people-outline"></i> <span> ContactUs </span> </a>
                                <ul >
                                	<li class="waves-effect active"><a href="${pageContext.request.contextPath}/admin/contactuslist"><i class="glyphicon glyphicon-list"></i>List Contact Us</a></li>
             ...
             <div class="content-page">
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <h4 class="page-title">Contact Us | List Contact Us </h4>
                        	...
                        	<div class="col-lg-12">
                        		<div class="card-box">
                        			...
                        			<div class="table-responsive">
                                        <table id="contactuslist" class="table table-actions-bar" >
                                           <thead>
                                           <tr>
                                              		<th> Id</th>
                                              		 <th>Name</th>
						...
						.DataTable(
							{
							    ...
							    "ajax": "${pageContext.request.contextPath}/admin/admin/contactuslist",
								"type" : "GET",
								"columns" : [
								...
								/* 	{
						...
						
 								 {
									data : "id",
									"render" : function(data, type, row, meta){
										return "<a href='${pageContext.request.contextPath}/admin/contactusdetails/" + row.id + "' class='glyphicon glyphicon-eye-open'> </a>";
									},  
