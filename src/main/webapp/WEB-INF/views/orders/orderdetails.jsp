				...
				<div class="container">
					...
					<div class="row">
						<div class="col-sm-12" align="left">
							<h4 class="page-title">Manage Orders | Show Order Details</h4>
							<ol class="breadcrumb">
     							 <li>
										<a href="${pageContext.request.contextPath}/orders/listorders">Orders List</a>
									</li>
									<li class="active">
										Order Details
									</li>
...
<!-- -----------------------------------------------FORM Start--------------------------------------------------------------------------------- -->
						...
						<a href="${pageContext.request.contextPath }/orders/listorders">
						...
						<form:form id="updateStatus"
						action="${pageContext.request.contextPath}/orders/orderdetails" method="POST" modelAttribute="orderdetails">
						<c:set var="reviewReview" value="0"/>
							<form:hidden path="id"/>
						<form:hidden path="user"/>
						<form:hidden path="subTotal"/>
						<form:hidden path="item_discount"/>
						...
						<form:hidden path="payment"/>
									...
									<b style="font-size: 22px">Order ID : ${orderdetails.id } </b>
									<br> <br> <br>
								...
								<!-- <div class="card-box" style="width: auto"> -->
								<b style="font-size: 20px" >Product Details </b>
								<br>
								<br>

				
								<c:forEach items="${orderdetails.orderitem }" var="products">
								<div>
								<b style="font-size: 18px">Product  ${products.id } :</b>
								</div>
								<br>
								<div class="row">
									<div class="col-sm-6">
										<div class="form-group">
											...
											<div>
												...
												<%-- <c:forEach items="${orderdetails.orderitem }" var="products"> --%>
													<form:input value="${products.product.product_name}"
													 disabled="true"
														path="orderitem" class="form-control" readonly="true" />
									...
									<%-- 	<c:forEach items="${orderdetails.orderitem }" var="products"> --%>
											<form:input 
												value="${products.product.created_at }" 
												 disabled="true" path="orderitem"
						...
						<div class="col-sm-6">
								<div class="form-group">
									<label >
										IsActive<span class="text-danger"></span>
									</label>
									<div>
									<%-- 	<c:forEach items="${orderdetails.orderitem }" var="products"> --%>
											<form:input type="text" value="${products.product.isactive }"  disabled="true"
												path="orderitem" class="form-control" readonly="true" />
									<%-- 	</c:forEach> --%>
									</div>
							...
							<div class="card-box" style="width: auto">
								<b style="font-size: 20px">Review And Rating Details </b>
<br>
								<br>
								<div class="row">
									<div class="col-sm-6">
								<div class="form-group">
									<label > Review
										...
										<div>
												...
												<c:forEach items="${review2}" var="reviews">
												
									
												
													<c:if test="${reviews ne null }">
										<c:if test="${reviews.orderDetails.id eq orderdetails.id }">
								
											<input type="text" disabled  value="${reviews.review}"
										...
										<div class="col-sm-6">
								          <div class="form-group">
													...
													<c:if test="${reviews ne null }">
										<c:if test="${reviews.orderDetails.id eq orderdetails.id }">
							   <input type="text"value="${reviews.rating}" disabled class="form-control" readonly/>
							...
							<div class="card-box" style="width: auto">
								<b style="font-size: 20px">User Details </b>
...
<br>
								...
								<div class="form-group">
									...
									<div>
										<form:input value="${orderdetails.user.firstname }"
										 disabled="true"
											path="user" class="form-control" readonly="true" />
									</div>
								</div>
								</div>
							...
							<div class="col-sm-6">
								<div class="form-group">
									...
									<div>
										<form:input value="${orderdetails.user.lastname }" 
										 disabled="true" path="user"
											class="form-control" readonly="true" />
									</div>
								</div>
								</div>
								...
								<div class="form-group">
									...
									<div>
										<form:input data-parsley-type="text"
										 disabled="true"
											value="${orderdetails.user.email}" path="user"
											class="form-control" readonly="true" />
									</div>
								</div>
								</div>
								...
								<div class="form-group">
									...
									<div>
										<form:input type="text" value="${orderdetails.user.gender}"
										 disabled="true"	path="user" class="form-control" readonly="true" />
									</div>
								</div>
								</div>
								...
								<div class="form-group">
									...
									<div>
										<form:input value="${orderdetails.user.mobile_no}" path="user"
										 disabled="true"	class="form-control" readonly="true" />
									</div>
								</div>
								</div>
								...
								<div class="form-group">
									...
									<div>
										<form:input type="text" name=""  disabled="true"
											value="${orderdetails.user.active}" path="user"
											class="form-control" readonly="true" />
									</div>
								</div>
								</div>
...
<br>
						...
						<div class="col-sm-6">
								<div class="form-group">
									...
									<div>
										<form:input path="payment"  disabled="true" class="form-control"
											value="${orderdetails.payment.mode}" readonly="true" />
									</div>
								</div>
								</div>
								...
								<div class="form-group">
									...
									<div>
										<form:input  disabled="true" value="${orderdetails.payment.paymentstatus}"
											path="payment" class="form-control" readonly="true" />
									</div>
								</div>
								</div>
							...
							<!-- ---------------------------------------------------------------- Shipping Status----------------------------------------------------------- -->
							<div class="card-box" style="width: auto">
								<b style="font-size: 20px">Shipping Status </b>
<br>
								<br>
								<div class="row">
						<div class="col-sm-6">
								...
								<div class="form-group">
									...
									<div>
										<div class="col-sm-10">
										<form:select path="orderstatus"  data-parsley-required-message="Please select  supplier" required="null" class="form-control">  
      										  <form:option value="" >---Select OrderStatus--------</form:option> 
         														<form:option value="Pending" label="Pending"/> 
      										  <form:option value="Shipped" label="Shipped"/>  
     											   <form:option value="Posted" label="Posted"/>  
									...
									<button   id="updateStatus"  type="button"  onclick="updateOrderDetailsbtn()"  class="btn btn-default waves-effect waves-light m-l-5"> Update </button>
									<br>
	...
	<!-- <------------------------------------------------Edit Function Start-----------------------------------------------------> -->
	<script>
	 function updateOrderDetailsbtn(){
		 $.ajax({
			 type:"POST",
			 url: "${pageContext.request.contextPath}/orders/orderdetails",
			 data:{
			 ...
			 success: function(result) {  
			        var link = "http://localhost:8090/eCommerce/orders/listorders";    
	...
	<!-- <script>
            ...
            $(document).ready(function() {
                $('#editStatus').submit(function(event)){
                	...
                	var data={
                			"id":orderdetails.getData(),
                			"orderstatus":orderdetails.getData()
                	}
                	$.ajax({
                		url:"${pageContext.request.contextPath}/orders/orderdetails/update_status",
                		...
                		beforeSend:function(){
                			$('#btn-edit-status').attr('disabled','disabled');
                			$('#btn-edit-status').val('submitting...');
