...
<html>
             ...
             <div class="content-page">
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <h4 class="page-title">Manage Orders | Pending Orders List</h4>
 ...
 -->-
                        			<div class="table-responsive">
                                        <table class="table table-actions-bar" id="pendingorderlist">
                                            <thead>
                                                <tr>
						...
						.DataTable(
							{
							    ...
							    "ajax": "${pageContext.request.contextPath}/orders/orders/pendingorderlist",
								"type" : "GET",
								"columns" : [ 
