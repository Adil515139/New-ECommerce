				...
				<div class="container">
					...
					<div class="row">
						<div class="col-sm-12" align="left">
							<h4 class="page-title">Users | Show User Details</h4>
							<ol class="breadcrumb">
								 <li>
						...
						<br>
							...
							<div class="card-box" style="width: auto">
								<h4 class="m-t-0 header-title">
									...
									<b style="font-size: 18px">User ID : ${userdetails.id } </b>
									<br> <br> <br>
...
<%-- 
								<b style="font-size: 15px">Product Details </b>
					...
					<%-- 		<div class="card-box" style="width: auto">
								<b style="font-size: 15px">Review And Rating Details </b>
								...
								<div class="form-group">
									...
									<div>
										<input type="text" disabled value="${review.review}"
											class="form-control" readonly="true" />
										<form:input value="${review.review}" path="review" class="form-control" readonly="true"  />
										...
										<div class="col-sm-6">
								          <div class="form-group">
                                                        ...
                                                        <div>
                                          <input type="text" disabled value="${review.rating}" class="form-control" readonly/>                                                  
												</div>    
                                         </div>
                                         </div>
							...
							<!-- <div class="card-box" style="width: auto"> -->
								...
								<div class="form-group">
									...
									<div>
										<form:input value="${userdetails.firstname }"
										 disabled="true"
											path="firstname" class="form-control" readonly="true" required="null" />
									</div>
								</div>
								</div>
							...
							<div class="col-sm-6">
								<div class="form-group">
									...
									<div>
										<form:input value="${userdetails.lastname }" 
										 disabled="true" path="lastname"
											class="form-control" readonly="true" required="null"  />
									</div>
								</div>
								</div>
								...
								<div class="form-group">
									...
									<div>
										<form:input data-parsley-type="text"
										 disabled="true"
											value="${userdetails.email}" path="email"
											class="form-control" readonly="true" required="null"  />
									</div>
								</div>
								</div>
								...
								<div class="form-group">
									...
									<div>
										<form:input type="text" value="${userdetails.gender}"
										 disabled="true"	path="gender" class="form-control" readonly="true" required="null"  />
									</div>
								</div>
								</div>
								...
								<div class="form-group">
									...
									<div>
										<form:input value="${userdetails.mobile_no}" path="mobile_no"
										 disabled="true"	class="form-control" readonly="true" required="null"  />
									</div>
								</div>
								</div>
								...
								<div class="form-group">
									...
									<div>
										<form:input type="text" name=""  disabled="true"
											value="${userdetails.active}" path="active"
											class="form-control" readonly="true" required="null"  />
									</div>
								</div>
								</div>
...
<b style="font-size: 18px">User Address </b>
<br>
<br>
								...
								<c:forEach items="${address }" var="addresss">
								
													<c:if test="${addresss ne null }">
													<c:if test="${addresss.user.id eq userdetails.id }">
									
										<div>
										<b style="font-size: 18px">Address  ${addresss.id } :</b>
										</div>
										<br>
										<div class="row">
									<div class="col-sm-6">
										...
										<div class="form-group">
											<label >
												Street and Landmark <span class="text-danger"></span>
											</label>
											<div>
												...
												<%-- 	<c:forEach items="${address }" var="addresss">
													<c:if test="${addresss ne null }">
													<c:if test="${addresss.user.id eq userdetails.id }"> --%>
												<input type="text" disabled value="${addresss.street_and_landmark}"
									...
									<div class="col-sm-6">
										...
										<%-- 	<c:forEach items="${address }" var="addresss">
													...
													<c:if test="${addresss.user.id eq userdetails.id }"> --%>
														...
														<input type="text" disabled value="${addresss.area}"
											class="form-control" readonly />
											<%-- </c:if>
											</c:if>
											</c:forEach> --%>
								...
								<%-- 	<c:forEach items="${address }" var="addresss">
													<c:if test="${addresss ne null }">
													<c:if test="${addresss.user.id eq userdetails.id }"> --%>
						<input type="text" disabled value="${addresss.city}"
											class="form-control" readonly />
						...
						<div class="col-sm-6">
								<div class="form-group">
									...
									<%-- <c:forEach items="${address }" var="addresss">
													<c:if test="${addresss ne null }">
													<c:if test="${addresss.user.id eq userdetails.id }"> --%>
										<input type="text" disabled value="${addresss.pincode}"
											class="form-control" readonly />
										<%-- 	</c:if>
											</c:if>
											</c:forEach> --%>
						...
						<div class="col-sm-6">
							...
							<%-- 		<c:forEach items="${address }" var="addresss">
													<c:if test="${addresss ne null }">
													<c:if test="${addresss.user.id eq userdetails.id }"> --%>
										<input type="text" disabled value="${addresss.state}"
											class="form-control" readonly />
								<%-- 	
									</c:if>
									</c:if>
								...
								<div class="form-group">
									...
									<%-- <c:forEach items="${address }" var="addresss">
													<c:if test="${addresss ne null }">
													<c:if test="${addresss.user.id eq userdetails.id }"> --%>
									<input type="text" disabled value="${addresss.country}"
											class="form-control" readonly />
									<%-- 		</c:if>
											</c:if>
											</c:forEach> --%>
